...
var D=Object.freeze(B([]));function E(a,b,c,d){b<a.i&&(void 0===d||!d)?a.l[b+a.h]=c:(a.j||(a.j=a.l[a.i+a.h]={}))[b]=c;return a}
;function fa(a,b){if(null!=a){if(Array.isArray(a))a=F(a,b);else if(C(a)){var c={},d;for(d in a)c[d]=fa(a[d],b);a=c}else a=b(a);return a}}
function F(a,b){for(var c=a.slice(),d=0;d<c.length;d++)c[d]=fa(c[d],b);if(b=Array.isArray(a)){var e;z?e=a[z]:e=a.g;b=(null==e?0:e)&1}b&&B(c);return c}
function ha(a){if(a&&"object"==typeof a&&a.toJSON)return a.toJSON();a:switch(typeof a){case "number":a=isFinite(a)?a:String(a);break a;case "object":if(a&&!Array.isArray(a)&&ea&&null!=a&&a instanceof Uint8Array){var b;void 0===b&&(b=0);if(!y){y={};for(var c="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".split(""),d=["+/=","+/","-_=","-_.","-_"],e=0;5>e;e++){var f=c.concat(d[e].split(""));x[e]=f;for(var h=0;h<f.length;h++){var k=f[h];void 0===y[k]&&(y[k]=h)}}}b=x[b];c=Array(Math.floor(a.length/
3));d=b[64]||"";for(e=f=0;f<a.length-2;f+=3){var r=a[f],A=a[f+1];k=a[f+2];h=b[r>>2];r=b[(r&3)<<4|A>>4];A=b[(A&15)<<2|k>>6];k=b[k&63];c[e++]=""+h+r+A+k}h=0;k=d;switch(a.length-f){case 2:h=a[f+1],k=b[(h&15)<<2]||d;case 1:a=a[f],c[e]=""+b[a>>2]+b[(a&3)<<4|h>>4]+k+d}a=c.join("")}}return Array.isArray(a)?F(a,ha):a}
;var ia;function G(a,b,c){var d=ia;ia=null;a||(a=d);d=this.constructor.W;a||(a=d?[d]:[]);this.h=(d?0:-1)-(this.constructor.V||0);this.g=void 0;this.l=a;a:{d=this.l.length;a=d-1;if(d&&(d=this.l[a],C(d))){this.i=a-this.h;this.j=d;break a}void 0!==b&&-1<b?(this.i=Math.max(b,a+1-this.h),this.j=void 0):this.i=Number.MAX_VALUE}if(c)for(b=0;b<c.length;b++)if(a=c[b],a<this.i)a+=this.h,(d=this.l[a])?Array.isArray(d)&&B(d):this.l[a]=D;else{d=this.j||(this.j=this.l[this.i+this.h]={});var e=d[a];e?Array.isArray(e)&&
B(e):d[a]=D}}
G.prototype.toJSON=function(){return F(this.l,ha)};
G.prototype.toString=function(){return this.l.toString()};function ja(a,b){var c=this.g;if(this.h){var d=!0;d=void 0===d?!1:d;if(b){var e=B([]);for(var f=0;f<b.length;f++)e[f]=b[f].l;a.g||(a.g={});a.g[c]=b}else a.g&&(a.g[c]=void 0),e=D;a=E(a,c,e,d)}else d=!0,a.g||(a.g={}),e=b?b.l:b,a.g[c]=b,a=E(a,c,e,void 0===d?!1:d);return a}
;function H(){G.apply(this,arguments)}
q(H,G);function I(){this.u=this.u;this.C=this.C}
...
q(J,H);function K(a){H.call(this,a)}
q(K,H);var ka=new function(a,b,c){this.g=a;this.h=c;this.i=ja}(406606992,K,0);function la(){K.apply(this,arguments)}
